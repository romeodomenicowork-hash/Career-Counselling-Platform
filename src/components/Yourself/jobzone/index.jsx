...
function Jobzone({ currentSection, handleBack, handleNext }) {
    ...
    <div>
      <div
        className={`bg-[#25bdea] rounded-[20px] sm:rounded-[40px] pb-[1px] shadow-md mt-[50px] 2xl:mt-[70px] ${
          currentSection === 7 ? "visible" : "hidden"
        }`}
      >
        <div className="flex justify-between items-center sm:px-8 p-4">
          {/* <h1 className="sm:text-[22px] lg:text-[36px] font-bold bg-gradient-to-r from-[#FFE259] to-[#FFA751] inline-block text-transparent bg-clip-text"> */}
        ...
        <div className="py-10 flex justify-center w-full gap-2 md:gap-3 items-center">
          ...
          <div className=" relative h-auto p-3 sm:p-6">
            <div className="flex gap-10 flex-col items-center mb-20 bg-white border  rounded-lg p-4 shadow lg:flex-row ">
              <img
              ...
              <div className="w-[100%] text-[16px] md:text-[20px] xl:text-[24px]">
                ...
                <h2 className="mt-3 font-semibold">
                  {" "}
                  How much education, training, and experience do I need to do
                  the job?
                </h2>
                <h2 className="mt-3">
                  Each SCHOLAR CLONE career is in one of five Job Zones, which are
                  groups of careers that need the same level
                  of experience, education, and training.
                </h2>
                <h2 className="mt-3">
                  Different careers need different amounts of preparation. You
                  will be asked to pick a Job Zone. Using your Job Zone and your
                  interests, the Interest Profiler will help you identify and
                  explore careers that might be right for you.
                </h2>
              </div>
            </div>
